...
float
MBinaryJaccard::measure(const Object *const obj1, const Object *const obj2) const {
  ...
  if(j != r2.end())
    denom += r2.end() - j;
  return div0(num, num + denom);
}

bool
MBinaryJaccard::heuristic(const Object *const obj1, const Object *const obj2) const {
...
void
MBinaryJaccard::explain(std::ostream &out, const Object *const obj1, const Object *const obj2) const {
  ulong ncommon = 0;
  ulong n1 = 0;
  ulong n2 = 0;
  ...
  if(true){
    ...
    print_common(out, ncommon, ncommon, 1.0);
    print_unique(out, obj1, n1, 0.0);
    print_unique(out, obj2, n2, 0.0);
    print_score(out, "Jaccard", ncommon, ncommon + n1 + n2);
  }else

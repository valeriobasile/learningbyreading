...
float
MDice2::measure(const Object *const obj1, const Object *const obj2) const {
  ...
  return 2*num/(r1.begin()->remainder() + r2.begin()->remainder());
};

bool
MDice2::heuristic(const Object *const obj1, const Object *const obj2) const {
...
void
MDice2::explain(std::ostream &out, const Object *const obj1, const Object *const obj2) const {
  float num = 0;
  float denom = 1; // obj1->remainder() + obj2->remainder();
  ...
  if(true){
    ...
    print_score(out, "Dice2", num, denom);
  }else

...
float
MCosine::measure(const Object *const obj1, const Object *const obj2) const {
...
bool
MCosine::heuristic(const Object *const obj1, const Object *const obj2) const {
...
void
MCosine::explain(std::ostream &out, const Object *const obj1, const Object *const obj2) const {
  float num = 0;
  float denom = obj1->score()*obj2->score();
  ...
  if(true){
    ...
    print_score(out, "Cosine", num, denom);
  }else

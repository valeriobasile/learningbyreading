...
float
MJaccard::measure(const Object *const obj1, const Object *const obj2) const {
...
bool
MJaccard::heuristic(const Object *const obj1, const Object *const obj2) const {
...
void
MJaccard::explain(std::ostream &out, const Object *const obj1, const Object *const obj2) const {
  float num = 0;
  float denom = 0;
  float s1 = 0;
  float s2 = 0;
  ...
  if(!use_heuristic || heuristic(obj1, obj2)){
    ...
    denom += s1 + s2;
    print_score(out, "Jaccard", num, denom);
  }else

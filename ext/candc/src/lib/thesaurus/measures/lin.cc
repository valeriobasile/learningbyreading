...
float
MLin::measure(const Object *const obj1, const Object *const obj2) const {
...
bool
MLin::heuristic(const Object *const obj1, const Object *const obj2) const {
...
void
MLin::explain(std::ostream &out, const Object *const obj1, const Object *const obj2) const {
  float num = 0;
  ulong ncommon = 0;
  ulong n1 = 0;
  ulong n2 = 0;

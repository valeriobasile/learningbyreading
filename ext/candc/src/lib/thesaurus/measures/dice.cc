...
float
MDice::measure(const Object *const obj1, const Object *const obj2) const {
...
bool
MDice::heuristic(const Object *const obj1, const Object *const obj2) const {
...
void
MDice::explain(std::ostream &out, const Object *const obj1, const Object *const obj2) const {
  float num = 0;
  ...
  if(true){
    ...
    print_score(out, "Dice", num, denom);
  }else
